...
public class DitaMapDataObject extends MultiDataObject {

    public DitaMapDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
